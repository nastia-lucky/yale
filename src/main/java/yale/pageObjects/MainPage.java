...
public class MainPage extends BasePage {
    ...
    public void clickSupportUsLink() {
        ...
        BaseElement.waitElementToBeClickable(SIDEBAR_NAVIGATION_GIVING);
    }
    ...
    public MainPage clickCalendarLink() {
        ...
        BaseElement.waitElementToBeClickable(SELECT_EVENT_BUTTON);
        return this;
    }
    ...
    public boolean isClinicalTrialHeaderIsDisplayed() {
        ...
        BaseElement.waitElementToBeClickable(CLINICAL_TRIAL_RESEARCH_LINK);
    ...
    public String getFirstEventTitle() {
        ...
        BaseElement.waitFirstElementFromArrayIsClickable(EVENT_TITLE);
    ...
    public boolean isTweetContainAuthor() {
        ...
        return baseElement.isElementInsideOtherContainText(TWEET_FEED, TWEET_AUTHOR);
    }

    @Step("Verify that each tweet contain author")
    public boolean isTweetContainTime() {
        Log.logInfo("Check that each tweet contain time");
        return baseElement.isElementInsideOtherContainText(TWEET_FEED, TWEET_TIME);
    }

    @Step("Verify that each tweet contain author")
    public boolean isTweetContainText() {
        Log.logInfo("Check that each tweet contain text");
        return baseElement.isElementInsideOtherContainText(TWEET_FEED, TWEET_TEXT);
    }
